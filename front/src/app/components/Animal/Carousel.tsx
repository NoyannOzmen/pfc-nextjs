...
export default function Carousel() {
  ...
  return (
    <section
      id="animal-carousel"
      className=" flex flex-row relative mx-auto w-[90%] h-auto bg-zoning rounded-lg shadow dark:bg-gray-800"
    >
      <button
      ...
      <div className="h-auto w-auto flex rounded-lg my-6 gap-4 px-8">{animalItems}</div>
