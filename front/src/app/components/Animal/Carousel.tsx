...
export default function Carousel() {
      ...
      <div className="flex bg-zoning rounded-lg shadow dark:bg-gray-800 flex-row md:flex-col p-4">
        ...
        <div className="flex-auto text-center">
          ...
          <div className="flex mb-4 text-sm font-medium">
            ...
            <Link className="py-2 px-4 bg-accents1-light text-fond w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg" href={`/animaux/${animal.id}`}>Découvrir</Link>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <section id="animal-carousel" className=" flex flex-row relative mx-auto w-[90%] h-auto bg-zoning rounded-lg shadow dark:bg-gray-800">
