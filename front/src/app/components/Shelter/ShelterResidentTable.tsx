            ...
            <div className="w-full md:w-1/2">
              ...
              <div className="flex p-6 pb-4">
                <div className="flex flex-col gap-2">
                  ...
                  <Link className="rounded-full block bg-accents1 text-fond w-28 text-center text-xs font-semibold px-6 hover:underline" href={`/associations/profil/animaux/${animal.id}`}>Détails</Link>
                </div>
