...
import { ITag, IAnimal, IFamille, IDemande } from '@/@types/index';
import { isShelter } from '@/components/isAuth';

type AnimalRequestCardProps = {
  animal: IAnimal;
  famille: IFamille;
  demande: IDemande;
};

function AnimalRequestCard({ animal, famille, demande }: AnimalRequestCardProps) {
      ...
      <div className="flex flex-col content-center justify-center mx-auto mb-4 w-[80%]">
        ...
        <div className="flex flex-col bg-zoning rounded-lg">
          ...
          <section className="flex flex-wrap justify-center" id="dashboard-container">
                  ...
                  <div className="flex flex-col gap-2">
                    {animal.images_animal[0].url ? (
                      <img
                        ...
                        src={
                          `${process.env.NEXT_PUBLIC_API_URL}` + `${animal.images_animal[0].url}`
                        }
            ...
            {/* <!-- PARTIE GESTION --> */}
            <ShelterRequestAdmin demande={demande} />
          </section>
        </div>
      </div>
    </main>
...
export default isShelter(AnimalRequestCard);
