  ...
  const requestItems = animal.demandes.map((demande: typeof animal.demandes) => (
    ...
    >
      ...
      <td className="text-center p-2 rounded-lg hover:underline">
        <Link href={`/associations/profil/demandes/${demande.Demande.id}`}>
        ...
        <div className="flex flex-col bg-zoning rounded-lg">
          <nav className="rounded-lg">
            <ul className="rounded-t-lg flex bg-accents2 justify-stretch font-semibold text-fond text-sm md:justify-start md:pl-8">
              <li className="dashsubbtn-active rounded-tl-lg block grow text-center pl-2 border-r-2 border-r-zoning py-2 hover:underline md:grow-0 md:px-4 md:rounded-none md:border-l-2 md:border-l-zoning bor">
              ...
              <li className="block grow text-center pr-2 py-2 rounded-tr-lg hover:underline md:grow-0 md:px-4 md:rounded-none md:border-r-solid md:border-r-2 md:border-r-zoning">
          ...
          >
            ...
            <div className="w-60 md:w-auto">
                ...
                <div className="flex flex-col gap-2">
                  {animalUrl ? (
                    <img
                      ...
                      src={`${process.env.NEXT_PUBLIC_API_URL}` + `${animalUrl}`}
              ...
              <div className="font-body mx-auto w-[80%] bg-zoning rounded-lg shadow dark:bg-gray-800 my-4">
                <ShelterAnimalUpload animalId={animal.id} />
              </div>
            </div>
