  ...
  return (
    <>
      ...
      <li className="border-2 border-accents2-dark mr-0 max-[767px]:border-b-fond  md:border-r-fond px-4 pr-6 max-[767px]:pb-2 place-self-center md:place-self-start">
        {auth.user?.accueillant && (
          <Link tabIndex={0} className="hover:text-accents1-light" href="/famille/profil">
            Mon profil
          </Link>
        )}
        {auth.user?.refuge && (
          <Link tabIndex={0} className="hover:text-accents1-light" href="/associations/profil">
            Tableau de&nbsp;bord
          </Link>
        )}
      </li>
