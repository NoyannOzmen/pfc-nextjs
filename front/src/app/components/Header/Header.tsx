...
export default function Header() {
  ...
  <>
    ...
    <Link href="/" className="flex flex-row grow-0 p-4">
    ...
    <div className="grow-1 flex flex-col md:flex-row flex-auto max-[767px]:nav-links" id="nav-links">
      ...
      {/* Menu Navigation */}
      <nav  onClick={closeMenu} className="flex flex-auto grow-1  place-self-center md:place-self-end pb-4 pr-4 text-m md:text-base xl:text-xl">
        <ul className="flex flex-auto flex-col md:flex-row md:place-content-end md:gap-5 pl-4 gap-2">
              <li className="hover:text-accents1-light place-self-start item-link">
                <Link tabIndex={0} href="/animaux">Nos Animaux</Link>
              </li>
              <li className="hover:text-accents1-light place-self-start item-link">
                <Link tabIndex={0} href="/associations">Nos Partenaires</Link>
              </li>
              <li className="hover:text-accents1-light place-self-start item-link">
                <Link tabIndex={0} href="/a-propos">Qui sommes&#x2011;nous&nbsp;?</Link>
              </li>
              <li className="hover:text-accents1-light place-self-start item-link">
                <Link tabIndex={0} href="/faq">Foire aux Questions</Link>
              </li>
              <li className="hover:text-accents1-light place-self-start item-link">
                <Link tabIndex={0} href="/devenir-famille-d-accueil">Devenez Famille&nbsp;d'accueil</Link>
              </li>
        </ul>
      </nav>
