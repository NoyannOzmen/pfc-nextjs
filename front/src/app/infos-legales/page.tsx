...
<main className="justify-self-stretch flex-1">
  <article className="p-32 mx-auto">
    ...
    Les coordonnées et un formulaire de contact sont disponibles sur le site sur la page de contact dédiée : <Link href="/contact">Contactez-nous</Link>
    ...
    <ul className="font-body text-texte text-m pb-4">
      ...
      <p className="font-body text-texte text-m pb-4">
        Des traitements de données à caractère personnel sont réalisés à travers l’utilisation du Site Web. Pour en savoir plus sur ces traitements, vous pouvez consulter notre <Link href="/rgpd">Politique de protection des données</Link></p>
