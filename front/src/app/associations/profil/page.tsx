...
function ShelterDashboard() {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const response = await fetch(process.env.NEXT_PUBLIC_API_URL + `/associations/profil`, {
        method: 'POST',
        headers: {
  ...
  async function handleDelete(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const response = await fetch(process.env.NEXT_PUBLIC_API_URL + `/association/profil/delete`, {
        method: 'POST',
      ...
      <div className="flex flex-col content-center justify-center mx-auto mb-4 w-[80%]">
          ...
          <ul className="flex flex-wrap-reverse gap-x-2 mx-3 justify-center font-semibold md:justify-start md:ml-10 text-xl">
            ...
            <li>
              <Link href="/associations/profil/animaux" tabIndex={0}>
                <button id="dashbtn-3" className="dashbtn" tabIndex={-1}>
                  Animaux
                </button>
              </Link>
            </li>
        ...
        <div className="font-body bg-zoning rounded-lg shadow dark:bg-gray-800 mb-4">
          ...
          <section className="flex flex-wrap justify-center" id="dashboard-container">
            ...
            <form
              className="flex flex-wrap content-center md:w-[60%] justify-center text-texte"
