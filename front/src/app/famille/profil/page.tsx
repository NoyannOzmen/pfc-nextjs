...
function FosterProfile() {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const response = await fetch(process.env.NEXT_PUBLIC_API_URL + `/famille/profil`, {
        method: 'POST',
        headers: {
  ...
  async function handleDelete(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const response = await fetch(process.env.NEXT_PUBLIC_API_URL + `/famille/profil/delete`, {
        method: 'POST',
      ...
      <div className="flex flex-col content-center justify-center mx-auto mb-4 w-[80%]">
        <nav className="flex flex-wrap justify-center md:justify-start">
          <ul className="flex flex-wrap-reverse gap-x-2 mx-3 justify-center font-semibold md:justify-start md:ml-10 text-xl">
            <li>
              <Link href="/famille/profil" tabIndex={0}>
            ...
            <li>
              <Link href="/famille/profil/demandes" tabIndex={0}>
